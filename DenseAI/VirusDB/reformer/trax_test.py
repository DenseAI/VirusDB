...
copy_inputs = trax.supervised.Inputs(lambda _: copy_task(16, 32, 10240))
...
def tiny_transformer_lm(mode):
    return trax.models.ReformerLM(  # You can try trax_models.ReformerLM too.  TransformerLM
        d_model=32, d_ff=64, n_layers=2, vocab_size=32, share_qk=True, attention_type= tl.LSHCausalAttention, mode=mode, max_len=10240)
