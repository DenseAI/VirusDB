...
if __name__ == '__main__':
    ...
    example_index = 1
    for ii in range(len(x_train[example_index])):
        if x_train[example_index][ii] in word_index_dict.keys():
            x_sent += ' ' + word_index_dict[x_train[example_index][ii]]
            x_raw.append(x_train[example_index][ii])

    y_sent += label_index_dict[y_train[example_index]]
